...
import (
	context "context"
	categories "cookly/business/categories"
...
func (_m *Repository) Create(ctx context.Context, data *categories.Domain) error {
...
func (_m *Repository) Update(ctx context.Context, data *categories.Domain, id int) error {
	ret := _m.Called(ctx, data, id)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *categories.Domain, int) error); ok {
		r0 = rf(ctx, data, id)
	} else {
		r0 = ret.Error(0)
	}
